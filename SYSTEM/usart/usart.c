...
#if EN_CP2102_USART1_RX   //如果使能了接收
//串口1中断服务程序
...
void CP2102_uart_init(u32 bound){
    //GPIO端口设置
...
void USART3_IRQHandler(void)                	//串口3中断服务程序
{
	if(USART_GetITStatus(USART3, USART_IT_RXNE) != RESET)  
		{
			g_ucRxd3 =USART_ReceiveData(USART3);//(USART3->DR);	//读取接收到的数据
      g_ucUart3Flag = 1;
     } 
